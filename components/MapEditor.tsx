...
const EditorScene: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Spawn Point Editor - Only render when loaded to prevent jumping to 0,0,0 */}
      {loaded && (
        <TransformControls 
            mode="translate" 
        ...
        >
            <mesh ref={meshRef} position={[spawnPos.x, spawnPos.y, spawnPos.z]}>
                ...
                <Html position={[0, 2, 0]} center>
                    <div className="bg-black/70 text-green-400 px-2 py-1 rounded text-xs font-mono whitespace-nowrap select-none">
                        SPAWN POINT
                    </div>
                </Html>
            </mesh>
